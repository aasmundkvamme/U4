                ...
                for studieprogram in emner['studieprogramkoblinger']:
                    if studieprogram is not None:
                        ...
                        if studieprogram['periode']['tilTermin'] is None:
                            ...
                            Undervises_siste_termin = emnestart_termin
                        else:
                            Undervises_siste_ar = studieprogram['periode']['tilTermin']
    ...
    with pyodbc.connect(conn_str) as cnxn:
        with cnxn.cursor() as cursor:
            ...
            for rad in emnekoblingar:
                ...
                # Versjonskode = rad['Versjonskode']
                # Studieprogramkode  = rad['Studieprogramkode']
                # Undervises_forste_ar = rad['Undervises_forste_ar']
                # Undervises_forste_termin = rad['Undervises_forste_termin']
                # Undervises_siste_ar = rad['Undervises_siste_ar']
                # Undervises_siste_termin = rad['Undervises_siste_termin']
                # Emnekode2 = rad['Emnekode2']
                # programEmneKode = rad['programEmneKode']
