...
account_users = alledata[['key.id', 'value.developer_key_id', 'value.user_id', 'value.real_user_id', 'value.last_used_at', 'value.expires_at', 'value.purpose', 'value.created_at', 'value.updated_at', 'value.scopes', 'value.workflow_state']]
